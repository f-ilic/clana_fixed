...
This is a super quickfix repo for https://github.com/MartinThoma/clana.
Tldr; fix the <3.6 python type annotations that work with newer python version, and remove all the file clutter.
