...
class ClanaCfg:
    ...
    def store_permutation(
        cls, cm_file: str, permutation: npt.ArrayLike, iterations: int
    ) -> None:
        """
        Store a permutation.
...
def read_confusion_matrix(cm_file: str, make_max: float = INFINITY) -> npt.ArrayLike:
    """
...
def write_cm(path: str, cm: npt.ArrayLike) -> None:
    """
