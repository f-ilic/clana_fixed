...
def calculate_score(cm: npt.ArrayLike, weights: npt.ArrayLike) -> int:
    """
...
def simulated_annealing(
    current_cm: npt.ArrayLike,
    current_perm: Union[None, List[int], npt.ArrayLike] = None,
    score: Callable[[npt.ArrayLike, npt.ArrayLike], float] = calculate_score,
    steps: int = 2 * 10**5,
    temp: float = 100.0,
    cooling_factor: float = 0.99,
    deterministic: bool = False,
    weightmatrix: npt.ArrayLike = None
) -> OptimizationResult:
    """
    ...
    score: Callable[[npt.ArrayLike, npt.ArrayLike], float], optional
        (default: )
    ...
    If you wanna fuck around with the weightmatrix pass it manually.
    weightmatrix:
...
def calculate_weight_matrix(n: int) -> npt.ArrayLike:
    """
...
def generate_permutation(
    n: int, current_perm: npt.ArrayLike, tmp_cm: npt.ArrayLike
...
def apply_permutation(
    cm: npt.ArrayLike, perm: Union[List[int], npt.ArrayLike]
) -> npt.ArrayLike:
    """
...
def move_1d(
    perm: npt.ArrayLike, from_start: int, from_end: int, insert_pos: int
) -> npt.ArrayLike:
    """
...
def move(
    cm: npt.ArrayLike, from_start: int, from_end: int, insert_pos: int
) -> npt.ArrayLike:
    """
...
def swap_1d(perm: npt.ArrayLike, i: int, j: int) -> npt.ArrayLike:
    """
...
def swap(cm: npt.ArrayLike, i: int, j: int) -> npt.ArrayLike:
    """
